...
public final class UxsdkWidgetShootPhotoBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static UxsdkWidgetShootPhotoBinding inflate(@NonNull LayoutInflater inflater,
      @NonNull ViewGroup parent) {
    if (parent == null) {
      throw new NullPointerException("parent");
    }
    inflater.inflate(R.layout.uxsdk_widget_shoot_photo, parent);
    return bind(parent);
  }

  @NonNull
  public static UxsdkWidgetShootPhotoBinding bind(@NonNull View rootView) {
