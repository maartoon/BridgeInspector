...
public final class UxsdkLiveviewPfdSpeedDisplayWidgetBinding implements ViewBinding {
  @NonNull
  ...
  private UxsdkLiveviewPfdSpeedDisplayWidgetBinding(@NonNull View rootView, @NonNull Space anchor,
  ...
  @NonNull
  public static UxsdkLiveviewPfdSpeedDisplayWidgetBinding inflate(@NonNull LayoutInflater inflater,
      @NonNull ViewGroup parent) {
    if (parent == null) {
      throw new NullPointerException("parent");
    }
    inflater.inflate(R.layout.uxsdk_liveview_pfd_speed_display_widget, parent);
    return bind(parent);
  }

  @NonNull
  public static UxsdkLiveviewPfdSpeedDisplayWidgetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UxsdkLiveviewPfdSpeedDisplayWidgetBinding(rootView, anchor, pfdSpeedDashBoard,
          pfdWsValue);
    }
