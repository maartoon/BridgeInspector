...
public final class UxsdkCellTextLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private UxsdkCellTextLayoutBinding(@NonNull View rootView, @NonNull IconicsImageView arrow,
  ...
  @NonNull
  public static UxsdkCellTextLayoutBinding inflate(@NonNull LayoutInflater inflater,
      @NonNull ViewGroup parent) {
    if (parent == null) {
      throw new NullPointerException("parent");
    }
    inflater.inflate(R.layout.uxsdk_cell_text_layout, parent);
    return bind(parent);
  }

  @NonNull
  public static UxsdkCellTextLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UxsdkCellTextLayoutBinding(rootView, arrow, content, icon, infoIv, subhead,
